...
async def _seed_admin_user(session: AsyncSession) -> None:
    ...
    # Seed admin with INITIAL_ADMIN_PASSWORD if set, otherwise use the
    # default password. Users change it via /admin/setup after first login.
    ...
    logger.info("Seeded admin user (change password via /admin/setup after first login)")
